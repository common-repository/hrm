...
class WP_Hrm {
    ...
    private function define_constants() {
        ...
        $this->define( 'HRM_PERMISSION_PURCHASE_URL', 'http://wpspear.com/product/hrm-permission/' );
    }
    ...
    function fornt_end() {
        ...
        ?>
         <div class="update-nag">
            ...
            then please go & purchase it, <a href="http://wpspear.com/product/hrm-front-end/" target="_blank">HRM front-end</a>'  ); ?>
        </div>
        <?php
    }
